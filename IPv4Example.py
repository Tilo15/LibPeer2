...
class GiveFileIPv4:
    ...
    def __init__(self, network, file_path):
        self.muxer = MX2()
...
if __name__ == "__main__":
    ...
    n1 = IPv4("172.16.4.162", 8001)
    n2 = IPv4("172.16.4.162", 8002)

    p2 = GiveFileIPv4(n1, "/home/bbarrow/Music/Snail Mail - Lush/Snail Mail - Lush - 08 Full Control.flac")
    p1 = GiveFileIPv4(n2, "/home/bbarrow/Music/Anders Enger Jensen - The Last Goddess OST/Anders Enger Jensen - The Last Goddess OST - 01 The Last Goddess Theme.flac")
